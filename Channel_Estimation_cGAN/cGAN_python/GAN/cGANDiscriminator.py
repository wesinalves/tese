...
class Discriminator(tf.keras.Model):
    def __init__(self):
        ...
        # downsample
        self.encoder_layer_1 = EncoderLayer(filters=64, kernel_size=4, apply_batchnorm=False, strides_s = 1) 
        self.encoder_layer_2 = EncoderLayer(filters=128, kernel_size=4, strides_s = 1)        
        self.encoder_layer_3 = EncoderLayer(filters=128, kernel_size=4, strides_s = 1)        
        ...
        #self.last = tf.keras.layers.Conv2D(1, 4, strides=2) 
